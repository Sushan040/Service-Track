...
<head>
<meta charset="UTF-8">
<title>Page Not Found - ServiceTrack</title>
<link
...
<body>
	<div class="error-container">
		...
		<p class="error-message">Oops! The page you are looking for seems
			to have wandered off the track.</p>
		<div>
			<a href="${pageContext.request.contextPath}/" class="btn-primary"><i
				class="fas fa-home"></i> Go to Homepage</a> <a
				href="javascript:history.back()" class="btn-secondary"><i
